...
<div class="container">
    <div class="row mt-5">
        ...
        <!-- <div class="col-md-7 mb-3">
            <a href="tambah.php" class="btn btn-sm btn-primary">Tambah Data Produk +</a>
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="produk_ubah.php?id=<?= $row["id"]; ?>" class="badge rounded-pill bg-primary text-decoration-none">Ubah</a>
                            <a href="produk_hapus.php?id=<?=$row["id"]; ?>" onclick=" return confirm('yakin?')" class="badge rounded-pill bg-danger text-decoration-none">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?> 
                </tbody>
